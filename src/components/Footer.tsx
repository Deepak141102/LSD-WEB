      ...
      <div className="container mx-auto px-6 pt-24 pb-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            >
              A unique, interactive footer design with dynamic elements and
              creative styling. Hover around to see the magic happen!
            </p>
            <div
              className={`p-3 rounded-lg ${
                isDarkMode ? "bg-gray-800" : "bg-white"
              } shadow-lg transform transition-all duration-300 hover:scale-105 cursor-pointer`}
              style={{
                boxShadow: `0 4px 20px rgba(${
                  isDarkMode ? "138, 75, 255" : "79, 70, 229"
                }, ${Math.max(
                  0,
                  0.2 -
                    calculateDistance(mousePosition.x, mousePosition.y) / 5000
                )})`,
              }}
            >
              <div className="flex items-center space-x-2">
