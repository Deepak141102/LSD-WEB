...
const ProjectCard = ({ project }) => {
  return (
    <>
      <div
        className="relative bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 flex flex-col h-full 
      ...
      >
        ...
        <div className="p-5 flex flex-col flex-grow">
          ...
          <div class="flex items-center  pt-0 mt-auto">
            <div class="flex gap-4">
              <a
                href="#"
                target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border rounded-md h-9 px-3 
             bg-black text-white  dark:bg-gray-800 dark:text-gray-100 dark:border-gray-700 dark:hover:bg-gray-700"
              >
                <Github />
                Code
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded-md h-9 px-3 border-[2px]
